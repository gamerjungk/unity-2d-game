...
namespace Gley.TrafficSystem.Editor
{
    public class VehicleTypesWindow : SetupWindowBase
    {
        ...
        private void Save()
        {
            FileCreator.CreateAgentTypesFile<VehicleTypes>(_vehicleCategories, TrafficSystemConstants.GLEY_TRAFFIC_SYSTEM, TrafficSystemConstants.trafficNamespace, TrafficSystemConstants.agentTypesPath);
        }
